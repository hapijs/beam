...
module.exports = internals.Connection = class {
    ...
    connect() {
        ...
        this._connection = this.settings.secure ? Tls.connect(this.settings.port, this.settings.hostname, Object.assign({ rejectUnauthorized: false }, this.settings.secure)) : Net.connect(this.settings.port, this.settings.hostname);
